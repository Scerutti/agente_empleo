...
#     buscador = Agent(
#         role='Scouter de Empleos HSE y Medio Ambiente',
#         goal='Encontrar búsquedas laborales recientes para roles de Gestión Ambiental, Coordinación de Planta o Analista HSE.',
#         backstory='Sos un headhunter especializado en el sector industrial, sustentabilidad y salud ambiental. Sabés identificar vacantes usando términos técnicos.',
#         tools=[buscar_web_tool],
#         llm=gemini_llm,
#         verbose=True
#     )
...
#     analista = Agent(
#         role='Auditor de Match Laboral',
#         goal='Filtrar y seleccionar ofertas web que hagan un excelente match con el perfil académico y de planta industrial provisto.',
#         backstory='Sos un selector de personal del área de ingeniería y ambiente. Evaluás si las ofertas encontradas se alinean al expertise en efluentes y normativa ambiental.',
#         llm=gemini_llm,
#         verbose=True
#     )
...
#     tarea_busqueda = Task(
#         description=f"Tomando como referencia estricta este perfil:\n{perfil_usuario}\n\n"
#                     f"Buscá ofertas laborales activas y recientes (cercanas al {fecha_hoy}). "
#                     "Utilizá términos de búsqueda como: 'Coordinador ambiental', 'Analista de Medio Ambiente planta', 'Salud Ambiental' o 'Efluentes y residuos'.",
#         expected_output="Un listado crudo de ofertas encontradas con título del puesto, empresa, ubicación y el link de la fuente.",
#         agent=buscador
#     )

#     tarea_analisis = Task(
#         description="Analizá las ofertas del buscador comparándolas minuciosamente con el perfil del archivo data/cv.md. "
#                     "Generá el archivo final evaluando los puntos fuertes de la candidata.",
#         expected_output="Un reporte detallado en Markdown ('reporte_empleos.md'). Cada puesto listado debe incluir: "
#                         "1. Nombre del Puesto y Empresa. "
#                         "2. Ubicación / Modalidad. "
#                         "3. Enlace directo para postularse. "
#                         "4. % de Match Estimado (0-100%). "
#                         "5. Puntos fuertes según su experiencia o formación.",
#         agent=analista,
#         output_file='reporte_empleos.md'
#     )
...
#     print("🚀 Buscando posiciones óptimas para el perfil ambiental...")
#     crew.kickoff()
#     print("\n✨ Proceso finalizado. Resultados listos en 'reporte_empleos.md'")
